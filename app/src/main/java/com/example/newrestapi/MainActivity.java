...
import com.example.administrator.api.R;

public class MainActivity extends Activity {
    EditText password, userName;
    Button login, resister;
    ProgressBar progressBar;
    private JSONObject doorJson;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                doorJson = new JSONObject();
                try {
                    doorJson.put("UserName", userName.getText().toString().trim());
                    doorJson.put("Password", password.getText().toString().trim());
    ...
    public String PostData(String[] valuse) {
        ...
        try {
            ...
            httpPost.setEntity(new StringEntity(doorJson.toString()));
